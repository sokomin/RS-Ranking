...
function getCSV(date1, date2, server, job) {
    url1 = "https://sokomin.github.io/RS-Ranking/out/korea_lv/" + date1 + "_" + server_name[server] + ".csv";
    url2 = "https://sokomin.github.io/RS-Ranking/out/korea_lv/" + date2 + "_" + server_name[server] + ".csv";
...
var obj_format = {0: "rank", 1: "img", 2:"name", 3:"lv", 4:"returner"};
var rank_now = {};
var rank_comp = {};
...
function createTable() {
    ...
    var $th_info = $('<tr>');
    var quest_title = "<th>順位</th><th>名前</th><th>レベル</th><th>転生</th><th>差分</th>"
    ...
    for (var i in rank_now) {
        ...
        var user_data = "<td>"+ data["rank"] +"</td><td>"+data["name"]+"</td><td>"+data["lv"]+"</td><td>"+data["returner"]+"</td><td>"+diff+"</td>";
        $rp.append(user_data);
        $table.append($rp);
        cnt++;
    }
